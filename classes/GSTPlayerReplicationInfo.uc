...
enum PlayerStat {
    ...
    WELDING, SELF_HEALS, BACKSTABS, 
    NUM_DECAPS, FLESHPOUNDS_RAGED, SCRAKES_RAGED,
    SCRAKES_STUNNED, SHOT_BY_HUSK, HUSKS_STUNNED
};

enum WeaponStat {
    PISTOL_ROUNDS_FIRED, RIFLE_ROUNDS_FIRED, AUTOMATIC_ROUNDS_FIRED,
    GRENADES_LAUNCHED, ROCKETS_LAUNCHED, 
    BOLTS_FIRED, BOLTS_RETRIEVED, SHELLS_FIRED, UNITS_FUEL, 
    MELEE_SWINGS, FRAGS_TOSSED, PIPES_SET, EXPLOSIVES_DISINTEGRATED,
    HEAL_DARTS_LANDED, HEAL_DARTS_FIRED
};
