...
defaultproperties {
    ...
    fireModeReplacement(36)=(oldClass=class'KFMod.MP5MFire',newClass=class'GameStatsTab.MP5MFire')
    fireModeReplacement(37)=(oldClass=class'KFMod.MP7MFire',newClass=class'GameStatsTab.MP7MFire')
    fireModeReplacement(38)=(oldClass=class'KFMod.PipeBombFire',newClass=class'GameStatsTab.PipeBombFire')
    fireModeReplacement(39)=(oldClass=class'KFMod.SCARMK17Fire',newClass=class'GameStatsTab.SCARMK17Fire')
    fireModeReplacement(40)=(oldClass=class'KFMod.ShotgunFire',newClass=class'GameStatsTab.ShotgunFire')
    fireModeReplacement(41)=(oldClass=class'KFMod.SingleFire',newClass=class'GameStatsTab.SingleFire')
    fireModeReplacement(42)=(oldClass=class'KFMod.WinchesterFire',newClass=class'GameStatsTab.WinchesterFire')
}
